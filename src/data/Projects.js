export default function Projects() {
  return [
    ...
    {
      image: '../assets/hackaton_sene.png',
      description: '',
    ...
    },
    {
      image: '../assets/hackaton_sene.png',
      description:
        "Ce projet a été développé en réponse à un concours de la SENE, visant à proposer une solution numérique pour la gestion des Déchets des Équipements Électriques et Électroniques (DEEE). Notre plateforme offre une solution intuitive pour simplifier la gestion de ces déchets, tout en contribuant à la préservation de l'environnement.",
      skills: ['Flutter', 'FastApi', 'Dart', 'Python'],
      site: '',
      github: 'https://github.com/Charlot-DEDJINOU/Stock-Master'
    },
    ...
    {
      image: '../assets/zero_plastique.png',
      description:
    ...
    {
      image: '../assets/car_location.webp',
      description:
    ...
    {
      image: '../assets/entretien_ia.jpeg',
      description:
    ...
    {
      image: '../assets/shared_preference.png',
      description:
