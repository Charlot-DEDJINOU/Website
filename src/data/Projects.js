...
export default function Projects() {
  return [
    ...
    },
    {
      ...
      skills: ['Data Science', 'IA', 'Machine Learning', 'Python'],
      site: '',
    ...
    },
    {
      ...
      image: hackaton_sene,
      description: "Une solution numérique développée lors du concours de la SENE pour simplifier la gestion des Déchets des Équipements Électriques et Électroniques.",
      skills: ['React jS', 'Laravel', 'Api-rest', 'Php', 'JS'],
      site: '',
    ...
    },
    {
      ...
      skills: ['Data Science', 'k-nn', 'Python', 'IA'],
      site: '',
      github:
